...
import { setBusca } from "../store/slices/buscaSlice";
import { RootState } from "../store";

export default function Header() {
  const dispatch = useDispatch();
  const busca = useSelector((state: RootState) => state.busca.termo);

  function handleBusca(e: React.ChangeEvent<HTMLInputElement>) {
    const valor = e.target.value;
    dispatch(setBusca(valor)); // atualiza o termo no Redux
  }
